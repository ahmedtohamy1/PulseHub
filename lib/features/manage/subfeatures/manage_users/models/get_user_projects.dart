...
class GetUsersProjects {
    ...
    factory GetUsersProjects.fromJson(Map<String, dynamic> json) => _$GetUsersProjectsFromJson(json);
...
class ProjectsList {
    ...
    factory ProjectsList.fromJson(Map<String, dynamic> json) => _$ProjectsListFromJson(json);
